...
*/
void PositionSensorHandler::measurementCallback(const Eigen::Vector3d& msg, unsigned char idx)
{
    ...
    Eigen::Matrix<double,3,1> z_p = Eigen::Matrix<double,3,1>(msg(0),msg(1),msg(2));
    /*
